...
public interface ISpecification<T, TResult> : ISpecification<T>
{
    ...
    /// <summary>
    /// The Selector transform function to apply to the <typeparamref name="T"/> element.
    /// </summary>
    Expression<Func<T, TResult>>? Selector { get; }
    
    /// <summary>
    /// The SelectorMany transform function to apply to the <typeparamref name="T"/> element.
    /// </summary>
    Expression<Func<T, IEnumerable<TResult>>>? SelectorMany { get; }
    
    /// <summary>
    /// The transform function to apply to the result of the query
    /// encapsulated by the <see cref="ISpecification{T,TResult}"/>
    /// </summary>
...
public interface ISpecification<T>
{
    ...
    /// <summary>
    /// The collection of <see cref="IncludeExpressions"/> describing each Include expression.
    ...
    /// <summary>
    /// The number of elements to skip before running the remaining elements
    /// </summary>
    int? Skip { get; }
    
    /// <summary>
    /// The transform action to apply to the result
    /// of the query encapsulated by the <see cref="ISpecification{T}"/>
    /// </summary>
    ...
    /// <summary>
    /// Returns whether or not the change tracker will track any of the entities
    /// that are returned. When true, if the entity instances are modified, this will
    /// not be detected by the change tracker.
    /// </summary>
    bool AsNoTracking { get; }
    
    /// <summary>
    /// Returns whether or not the generated SQL query should be split into
    ...
    /// <summary>
    /// Returns whether or not the query should ignore 
    /// </summary>
